...
<html>
    ...
    <script type="text/javascript">
      ...
      function initialize() {
        ...
        jQuery.each(markers, function(i, val) {
		  ...
		  var markerImage = new google.maps.MarkerImage("./images/icons/coworking.png", null, null, null, iconSize);
  ...
  <body>
    ...
    <div class="topbar" id="topbar">
      <div class="wrapper" style="margin:0px auto; width:1004px;">
        <!-- <<div class="right">
          div class="share">
        ...
        <div class="left" style="text-align:center;width:1004px;">
          <div class="logo">
            <a href="./">
          ...
          <div class="buttons" style="float:right; margin-top:50px;">
            ...
            <?php if($sg_enabled) { ?>
              <a href="#modal_add_choose" class="btn btn-large btn-success" data-toggle="modal"><i class="icon-plus-sign icon-white"></i>Add Location</a>
            <? } else { ?>
    ...
    <script>
      ...
      $("#modal_addform").submit(function(event) {
		...
		/* title: title, type: type, uri: uri, description: description */
        $.post( url, { owner_name: owner_name, owner_email: owner_email, address: address},
          function( data ) {
            ...
            if(data == "success") {
			  ...
			  $("#modal_addform #result").html("Thank you for submission.");
              $("#modal_addform #result").addClass("alert alert-success");
